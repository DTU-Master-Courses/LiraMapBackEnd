...
def test_get_single_trip():
    async def run_test(client):
        ...
        assert res.json() == {
            "id": "003a157f-786a-4430-b6c7-c48f6f968364",
            "task_id": 4020,
            "start_time_utc": "2020-08-01T15:52:10.053325+00:00",
            "end_time_utc": "2020-08-01T15:55:35.991564+00:00",
            "start_position_lat": "55.453020",
            ...
            "end_position_lat": "55.448430",
            "end_position_lng": "11.210200",
            ...
            "duration": "2020-08-26T00:03:25.938239+00:00",
            "distance_km": 0.642550058722749,
            "fk_device": "187c70cc-4eff-4307-8157-ac0fa0102f43",
            "created_date": "2020-08-26T11:45:20.290879+00:00",
            "updated_date": "0001-01-01T00:00:00+00:00",
            "fully_imported": True,
        }
...
def test_get_acceleration_trip():
    async def run_test(client):
        res = await client.get(
            "/segments/acceleration/351c02c6-733e-4a4b-a0c1-e6cad55b931f"
        )
        assert res.status_code == 200
        assert res.json()["acceleration"][0] == {
            "x": -0.15444444444444447,
            "y": -0.2422222222222222,
            "z": 1.0022222222222223,
            "lon": 12.530856499999997,
            "lat": 55.72094272222222,
            "created_date": "2020-07-09T19:53:33",
        }
...
def test_get_all_speed_agg():
    async def run_test(client):
        res = client.get(
            "/trips/list_of_speed_agg/2857262b-71db-49df-8db6-a042987bf0eb"
        )
        assert res.status_code == 200
